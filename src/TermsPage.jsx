			...
			<div className='terms-container'>
				...
				<div className='terms-content'>
					<section className='terms-section'>
						...
						<ol>
							<li>
								Niniejszy Regulamin określa zasady korzystania z serwisu internetowego OrderManager, dostępnego pod
								adresem ordermanager.pl, zwanego dalej „Serwisem".
							</li>
							<li>
								Właścicielem i administratorem Serwisu jest właściciel domeny ordermanager.pl, zwany dalej
								„Usługodawcą".
							</li>
							<li>
								Serwis jest aplikacją webową typu SaaS (Software as a Service), umożliwiającą w szczególności
								zarządzanie zamówieniami, klientami oraz danymi związanymi z działalnością Użytkownika.
							</li>
					...
					<section className='terms-section'>
						...
						<ul>
							...
							<li>
								<strong>Konto</strong> – indywidualny dostęp do Serwisu przypisany do Użytkownika.
							</li>
							<li>
								<strong>Abonament</strong> – płatny plan umożliwiający korzystanie z określonych funkcjonalności
								Serwisu.
							</li>
							<li>
								<strong>Dane</strong> – wszelkie informacje wprowadzane, przechowywane lub przetwarzane w Serwisie przez
								Użytkownika.
							</li>
						</ul>
					</section>
					...
					<section className='terms-section'>
						...
						<ol>
							...
							<li>
								Zabronione jest wykorzystywanie Serwisu w sposób mogący zakłócić jego działanie lub naruszać prawa osób
								trzecich.
							</li>
						</ol>
					</section>
					...
					<section className='terms-section'>
						...
						<ol>
							...
							<li>
								Użytkownik zobowiązany jest do zabezpieczenia dostępu do Konta oraz nieudostępniania danych logowania
								osobom trzecim.
							</li>
					...
					<section className='terms-section'>
						...
						<ol>
							...
							<li>
								Brak opłacenia Abonamentu może skutkować:
								<ul>
							...
							<li>
								Opłaty nie podlegają zwrotowi, o ile bezwzględnie obowiązujące przepisy prawa nie stanowią inaczej.
							</li>
						</ol>
					</section>
					...
					<section className='terms-section'>
						...
						<ol>
							...
							<li>
								Użytkownik, wprowadzając dane do Serwisu, oświadcza, że posiada podstawę prawną do ich przetwarzania.
							</li>
					...
					<section className='terms-section'>
						...
						<ol>
							...
							<li>
								Użytkownik przyjmuje do wiadomości, że korzystanie z Serwisu wiąże się z ryzykiem wynikającym z
								charakteru usług elektronicznych.
							</li>
							<li>
					...
					<section className='terms-section'>
						...
						<ol>
							...
							<li>
								Odpowiedzialność Usługodawcy, w zakresie dopuszczalnym przez prawo, ograniczona jest do szkody
								rzeczywistej.
							</li>
						</ol>
					</section>
					...
					<section className='terms-section'>
						...
						<ol>
							<li>Zasady przetwarzania danych osobowych określa Polityka Prywatności dostępna pod adresem [link]. Akceptując niniejszy Regulamin, Użytkownik potwierdza zapoznanie się z Polityką Prywatności.</li>
					...
					<section className='terms-section'>
						<h2>§10. Zawieszenie i usunięcie Konta</h2>
						<ol>
